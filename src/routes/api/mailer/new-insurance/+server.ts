...
export const POST: RequestHandler = async ({ request }) => {
    ...
    try {
        ...
        //                         <div class="step-box">
        //                             <p style="margin: 0;"><span class="step-number">1.</span> <strong>Scarica il modulo allegato</strong> a questa email (MODULO ADESIONE CON TUTELA.pdf)</p>
        //                         </div>

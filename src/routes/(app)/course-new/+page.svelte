...
>
	<header class="col-span-4 text-center text-2xl font-bold text-green-800">Nuovo Corso</header>
	<!-- Categoria  -->
	...
	<!-- <section class="col-span-4 md:col-span-1">
		<label for="data-inizio-giorno" class="form-label">
			<p class="font-bold mb-2">Data inizio</p>
		</label>
		<div class="join join-horizontal rounded-md">
			<button class="join-item bg-gray-300 px-3"><Calendar /></button>
			<input
				...
				type="text"
				placeholder="GG"
				aria-label="data-inizio-giorno"
				aria-describedby="data-inizio-giorno"
				bind:value={productCorsoDataInizioGiorno}
				onchange={() => {
					if (Number(productCorsoDataInizioGiorno) > 31) {
						productCorsoDataInizioGiorno = pad(31);
					} else {
						productCorsoDataInizioGiorno = pad(productCorsoDataInizioGiorno);
					}
				}}
				oninput={() => {
					productCorsoDataInizioGiorno = containsOnlyNumbers(productCorsoDataInizioGiorno);
				}}
				maxlength="2"
				required
			/>
			...
			<input
				...
				type="text"
				placeholder="MM"
				aria-label="data-inizio-mese"
				aria-describedby="data-inizio-mese"
				bind:value={productCorsoDataInizioMese}
				onchange={() => {
					if (Number(productCorsoDataInizioMese) > 12) {
						productCorsoDataInizioMese = pad(12);
					} else {
						productCorsoDataInizioMese = pad(productCorsoDataInizioMese);
					}
				}}
				oninput={() => {
					productCorsoDataInizioMese = containsOnlyNumbers(productCorsoDataInizioMese);
				}}
				maxlength="2"
				required
			/>
			<button class="join-item bg-gray-300 px-3"> - </button>
			<input
				class="input input-bordered rounded-r-md w-20"
				id="data-inizio-anno"
				type="text"
				placeholder="AAAA"
				aria-label="data-inizio-anno"
				aria-describedby="data-inizio-anno"
				bind:value={productCorsoDataInizioAnno}
				oninput={() => {
					productCorsoDataInizioAnno = containsOnlyNumbers(productCorsoDataInizioAnno);
				}}
	...
	<!-- <section class="col-span-4 md:col-span-1">
		<label for="data-inizio-ora" class="form-label">
			<p class="font-bold mb-2">Orario inizio</p>
		</label>
		<div class="join join-horizontal rounded-md">
			<input
				class="input input-bordered rounded-l-md w-14"
				id="data-inizio-ora"
				type="text"
				placeholder="Ora"
				aria-label="data-inizio-ora"
				aria-describedby="data-inizio-ora"
				bind:value={productCorsoDataInizioOra}
				onchange={() => {
					if (Number(productCorsoDataInizioOra) > 23) {
						productCorsoDataInizioOra = pad(23);
					} else {
						productCorsoDataInizioOra = pad(productCorsoDataInizioOra);
					}
				}}
				oninput={() => {
					productCorsoDataInizioOra = containsOnlyNumbers(productCorsoDataInizioOra);
				}}
				maxlength="2"
				required
			/>
			<button class="join-item bg-gray-300 px-3"> - </button>
			<input
				class="input input-bordered rounded-r-md w-14"
				id="data-inizio-minuto"
				type="text"
				placeholder="Minuti"
				aria-label="data-inizio-minuto"
				aria-describedby="data-inizio-minuto"
				bind:value={productCorsoDataInizioMinuto}
				onchange={() => {
					if (Number(productCorsoDataInizioMinuto) > 59) {
						productCorsoDataInizioMinuto = pad(59);
					} else {
						productCorsoDataInizioMinuto = pad(productCorsoDataInizioMinuto);
					}
				}}
				oninput={() => {
					productCorsoDataInizioMinuto = containsOnlyNumbers(productCorsoDataInizioMinuto);
				}}
				maxlength="2"
				required
			/>
	...
	<!-- <section class="col-span-4 md:col-span-1">
		<label for="data-fine-giorno" class="form-label">
			<p class="font-bold mb-2">Data fine</p>
		</label>
		<div class="join join-horizontal rounded-md">
			<button class="join-item bg-gray-300 px-3"><Calendar /></button>
			<input
				...
				type="text"
				placeholder="GG"
				aria-label="data-fine-giorno"
				aria-describedby="data-fine-giorno"
				bind:value={productCorsoDataFineGiorno}
				onchange={() => {
					if (Number(productCorsoDataFineGiorno) > 31) {
						productCorsoDataFineGiorno = pad(31);
					} else {
						productCorsoDataFineGiorno = pad(productCorsoDataFineGiorno);
					}
				}}
				oninput={() => {
					productCorsoDataFineGiorno = containsOnlyNumbers(productCorsoDataFineGiorno);
				}}
				maxlength="2"
				required
			/>
			...
			<input
				...
				type="text"
				placeholder="MM"
				aria-label="data-fine-mese"
				aria-describedby="data-fine-mese"
				bind:value={productCorsoDataFineMese}
				onchange={() => {
					if (Number(productCorsoDataFineMese) > 12) {
						productCorsoDataFineMese = pad(12);
					} else {
						productCorsoDataFineMese = pad(productCorsoDataFineMese);
					}
				}}
				oninput={() => {
					productCorsoDataFineMese = containsOnlyNumbers(productCorsoDataFineMese);
				}}
				maxlength="2"
				required
			/>
			...
			<input
				...
				type="text"
				placeholder="AAAA"
				aria-label="data-fine-anno"
				aria-describedby="data-fine-anno"
	...
	<!-- <section class="col-span-4 md:col-span-1">
		<label for="data-fine-ora" class="form-label">
			<p class="font-bold mb-2">Orario fine</p>
		</label>
		<div class="join join-horizontal rounded-md">
			<input
				class="input input-bordered rounded-l-md w-14"
				...
				type="text"
				placeholder="Ora"
				aria-label="data-fine-ora"
				aria-describedby="data-fine-ora"
				bind:value={productCorsoDataFineOra}
				onchange={() => {
					if (Number(productCorsoDataFineOra) > 23) {
						productCorsoDataFineOra = pad(23);
					} else {
						productCorsoDataFineOra = pad(productCorsoDataFineOra);
					}
				}}
			...
			<input
				...
				type="text"
				placeholder="Minuti"
				aria-label="data-fine-minuto"
				aria-describedby="data-fine-minuto"
				bind:value={productCorsoDataFineMinuto}
				onchange={() => {
					if (Number(productCorsoDataFineMinuto) > 59) {
						productCorsoDataFineMinuto = pad(59);
					} else {
						productCorsoDataFineMinuto = pad(productCorsoDataFineMinuto);
					}
				}}
				oninput={() => {
					productCorsoDataFineMinuto = containsOnlyNumbers(productCorsoDataFineMinuto);
				}}
				maxlength="2"
				required
			/>
